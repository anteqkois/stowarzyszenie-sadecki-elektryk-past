...
function moreOfProject (){
    ...
    //const projectId = this.getAttribute('idOfProject');
    //console.log(projectId)
    //console.log(document.getElementById(projectId))
    //document.getElementById(projectId).parentElement.classList.add('project--active');

}


document.querySelectorAll('.project__button').forEach(button => button.addEventListener('click', moreOfProject));